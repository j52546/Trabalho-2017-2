...
public class RealizarVendaPainel extends JPanel{
	...
	public void setCenterPanel() {
		...
		qtdMax = new JLabel();
		qtdMax.setText("Quantidade em Estoque");
		this.gridBag.add(this.qtdMax, gbc);
		...
		columnNames.add("Data do Pedido");
	...
	public void qtdDisp(String nome) {
		
		for(ProdutoTO produto : produtos) {
			if(produto.getNome().equals(nome)) {
				qtdMax.setText("Quantidade disponivel " + produto.getQuantidade());
			}	
		}
	}
	...
	public void setPedido() {
		...
		String nomeProdudo = comboBox.getSelectedItem().toString();
